...
namespace Smartest.App_Data
{
    // ************************************************************************
    // Unit of work
    public interface ISmartest : IDisposable
    {
    ...
    // ************************************************************************
    // Database context
    public class Smartest : DbContext, ISmartest
    {
        public IDbSet<Game> Games { get; set; } // Games
        
        static Smartest()
        {
            Database.SetInitializer<Smartest>(null);
        }
        ...
        public Smartest(string connectionString) : base(connectionString)
        {
        }

        public Smartest(string connectionString, System.Data.Entity.Infrastructure.DbCompiledModel model) : base(connectionString, model)
        {
        }
    ...
    public class FakeSmartest : ISmartest
    {
